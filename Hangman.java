...
public class Hangman {
     ...
     */
    public static boolean updateWithGuess(String word, char [] knownLetters,
                                          char guessedLetter) {
    ...
    //for the longest time i was freaking out bc my parameters weren't in
    //the right order and i kept getting an error so moral of the story:
    //pay attention to the order your parameters are in if they're being
    //checked in a method later on
    //
    ...
    public static void main(String[] args) {
        ...
        String[] words = {"aardvark", "alligator", "alpaca", "anteater",
                ...
                "wombat", "woodchuck", "yak", "zebra", "fuck", "shit",
                "godfuckingdamnit", "somanyfuckinganimals"};
        //easter egg hunt!
        //see if you can find the added words xD
